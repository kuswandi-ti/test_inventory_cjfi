...
class CreateBarangmasukAfterdeleteTrigger extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared('
            CREATE TRIGGER `trg_barangmasuk_afterdelete`
            AFTER DELETE ON `barang_masuk_dtl` FOR EACH ROW
            BEGIN
                ...
                /*
                    ...
                    2. Kurangkan stok terakhir dengan qty yg dihapus
                */
                ...
                VALUES (v_no_dokumen, v_tgl_dokumen, v_nama_transaksi, OLD.kode_barang, concat("Transaksi dihapus sebanyak : ", OLD.qty), v_qty_onhand, 0, OLD.qty, v_qty_balance, NOW(), NOW());
            END
        ');
    }
    ...
    {
        Schema::dropIfExists('trg_barangmasuk_afterdelete');
    }
}
