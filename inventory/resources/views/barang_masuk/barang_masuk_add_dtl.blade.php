...
@section('content')
    <div class="section-body">
        ...
        <form id="form_barangmasuk_dtl" action="{{ route('barangmasuk_updatehdr', $data_header->id) }}" method="POST">
            @csrf
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Tambah Data Barang Masuk (Detail)</h4>
                        </div>
                        <div class="card-body">
        ...
        $(document).ready(function() {
            ...
            $("#btn_simpan").click(function(e) {
                ...
                $.ajax({
                    url : url,
                    method : 'POST',
                    data : $('#form_barangmasuk_dtl').serialize(),
