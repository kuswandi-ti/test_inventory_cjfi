...
@section('content')
    <div class="section-body">
        ...
        <form id="form_barangkeluar_dtl" action="{{ route('barangkeluar_updatehdr', $data_header->id) }}" method="POST">
            @csrf
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Tambah Data Barang Keluar (Detail)</h4>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-icon btn-block btn-info"><i class="fas fa-save"></i> Simpan</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            $("#btn_simpan").click(function(e) {
                ...
                $.ajax({
                    url : url,
                    method : 'POST',
                    data : $('#form_barangkeluar_dtl').serialize(),
